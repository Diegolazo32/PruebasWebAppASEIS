...
public class TestWebVerDetallesNoDisp {
    ...
    @Test(priority = 1)
    public void Ver_detallesCursoNoDisponible() throws InterruptedException {
    	
    	// Navegar a la página de creación de cursos
    	driver.get("http://127.0.0.1:8000/Docente/indexCursosNoDisponiblesDocente");
    	Thread.sleep(3000);
        
    	//Busca el boton de mas informacion y da click
        driver.findElement(By.className("btnVerMasCurso")).click();
        Thread.sleep(3000);
