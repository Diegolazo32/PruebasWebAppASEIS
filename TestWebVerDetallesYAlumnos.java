...
public class TestWebVerDetallesYAlumnos {
    ...
    @Test(priority = 1)
    public void Ver_alumnos() throws InterruptedException {
        ...
        //Busca el el boton de ver estudiantes y espera 3s
        driver.findElement(By.id("btnVerMasEst")).click();
        Thread.sleep(3000);
        
      //Busca el el boton de ver estudiantes y espera 3s
        driver.findElement(By.id("BackBtnPub")).click();
        Thread.sleep(3000);
